...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/nextSunday/index.js");
...
/* harmony import */ var _todos_todos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../todos/todos */ "./src/todos/todos.js");
...
const samples = (() => {
  ...
  let todayToDosSubHeading = () => {
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), "'It´s' cccc 'the' do 'of' MMMM");
  };

  let weekToDosHeading = "Weekly To Dos";
  let weekToDosSubHeading = () => {
    let weekEnd = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date());
    let weekStart = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(weekEnd, 6);
    let weekStartString = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(
      weekStart,
      "'You´re weekly Todo´s from' EEEEEE'. the' do 'to'",
    );
    let weekEndString = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(weekEnd, " EEEEEE. 'the' do");
  ...
  const getSampleProject = () => {
    ...
    let todoDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), "yyyy-MM-dd");
    let toDo1 = (0,_todos_todos__WEBPACK_IMPORTED_MODULE_0__.ToDo)(
      "💡 Click + Add Project to personalize your project portfolio",
    );
    let toDo2 = (0,_todos_todos__WEBPACK_IMPORTED_MODULE_0__.ToDo)(
      "💡 Set up to dos for each project with the add to do button",
    );
    let toDo3 = (0,_todos_todos__WEBPACK_IMPORTED_MODULE_0__.ToDo)("💡 Give your ToDos names and dates");
    let toDo4 = (0,_todos_todos__WEBPACK_IMPORTED_MODULE_0__.ToDo)(
      "💡 Ohh Ohh, seems like this one is due today",
      "",
      todoDate,
    );
    let toDo5 = (0,_todos_todos__WEBPACK_IMPORTED_MODULE_0__.ToDo)("💡 Check off your ToDos if done", "", todoDate, false);
    let toDoArray = [toDo1, toDo2, toDo3, toDo4, toDo5];

    let sampleProject = (0,_projects_projects__WEBPACK_IMPORTED_MODULE_1__.Project)(heading, description);
    toDoArray.forEach((e) => {
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/nextSunday/index.js");
...
/* harmony import */ var _todos_todos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../todos/todos */ "./src/todos/todos.js");
/* harmony import */ var _projects_projects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../projects/projects */ "./src/projects/projects.js");
/* harmony import */ var _samples__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./samples */ "./src/UI/samples.js");
/* harmony import */ var _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../projects/project_storage */ "./src/projects/project_storage.js");
...
const domManipulation = (() => {
  ...
  const closeEditToDoForm = (toDoObject) => {
    ...
    const formattedDate = toDoObject.getDueDate()
      ? (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(toDoObject.getDueDate()), "dd/MM/yyyy")
      : "";
  ...
  const renderOneToDo = (toDo, projectName) => {
    ...
    const toDoDate = toDo.getDueDate()
      ? (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(toDo.getDueDate()), "dd/MM/yyyy")
      : "";
  ...
  const openNavPage = (page) => {
    ...
    switch (page) {
      case "all":
        heading = _samples__WEBPACK_IMPORTED_MODULE_2__.samples.allToDosHeading;
        subHeading = _samples__WEBPACK_IMPORTED_MODULE_2__.samples.allToDosSubHeading;
        break;
      case "today":
        heading = _samples__WEBPACK_IMPORTED_MODULE_2__.samples.todayToDosHeading;
        subHeading = _samples__WEBPACK_IMPORTED_MODULE_2__.samples.todayToDosSubHeading();
        break;
      case "week":
        heading = _samples__WEBPACK_IMPORTED_MODULE_2__.samples.weekToDosHeading;
        subHeading = _samples__WEBPACK_IMPORTED_MODULE_2__.samples.weekToDosSubHeading();
    }
...
const eventListener = (() => {
  ...
  const _checkForLocalStorage = () => {
    if (localStorage.length == 0) _setUpProject(_samples__WEBPACK_IMPORTED_MODULE_2__.samples.getSampleProject());
    else _loopLocalStorage();
  };

  const _setUpProject = (newProject) => {
    // save created object and update local storage
    _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.addProjectObject(newProject.getName(), newProject);
    _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.setCurrentProject(newProject);
  ...
  const _loopLocalStorage = () => {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      const newProject = (0,_projects_projects__WEBPACK_IMPORTED_MODULE_1__.Project)(
        storageProject.name,
      ...
      for (const key in storageProjectToDos) {
        const newToDo = (0,_todos_todos__WEBPACK_IMPORTED_MODULE_0__.ToDo)(
  ...
  const handleToDoFormSubmit = () => {
    ...
    form.addEventListener("submit", (e) => {
      ...
      // create ToDo object
      const newToDo = (0,_todos_todos__WEBPACK_IMPORTED_MODULE_0__.ToDo)(todoName.value, "", todoDate.value, false);

      // add todo to assosiated project
      const project = _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.getCurrentProject();
      project.addToDo(newToDo, newToDo.getName());

      // update local storage
      _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.updateLocalStorage();
  ...
  const _validateProjectForm = () => {
    ...
    const projects = _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.getProjectObjectArray();
  ...
  const _handleProjectFormSubmit = () => {
    ...
    const _setUpProjectPage = () => {
      ...
      const newProject = (0,_projects_projects__WEBPACK_IMPORTED_MODULE_1__.Project)(
        input.value,
        _samples__WEBPACK_IMPORTED_MODULE_2__.samples.getProjectDescriptionSample(),
      );
      _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.addProjectObject(newProject.getName(), newProject);
      _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.setCurrentProject(newProject);
      _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.updateLocalStorage();
  ...
  const _handleProjectEdit = () => {
    if (_status) {
      domManipulation.openEditProjectForm(
        _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.getCurrentProject(),
      );
      setStatus(false);
      handleProjectEditFormSubmit(_projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.getCurrentProject());
    } else return;
  };
  ...
  const _handleProjectDelete = () => {
    if (_status) {
      ...
      _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.removeProjectObject(
        _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.getCurrentProject().getName(),
      );

      // remove project navigation element
      _projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.getCurrentProject().getProjectDomElement().remove();
  ...
  const _allPageListener = () => {
    ...
    allPageButton.addEventListener("click", () => {
      ...
      domManipulation.removeToDos(_projects_project_storage__WEBPACK_IMPORTED_MODULE_3__.projectObjectStorage.getCurrentProject());
  ...
  const _getFormattedDate = (date) => (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(date, "yyyy-MM-dd");

  const _isWithinCurrentWeek = (date) => {
    const weekEnd = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date());
    const weekStart = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(weekEnd, 7);
    const week = {
      start: weekStart,
      end: weekEnd,
    };

    return (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date), week);
  };
